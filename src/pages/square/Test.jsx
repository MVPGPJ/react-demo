                            ...
                            <div style={{ height: '100%' }}>
                                ...
                                >
                                    <div className="recommend" style={{ flex: 1, backgroundColor: this.props.background }}>
                                        ...
                                        <Scroll tabNumber={0} fatherSe=".recommend" render={com => (<SquareItemContainer key='1' backgroundColor={this.props.background} squareData={com} tabNumber={0}></SquareItemContainer>)}></Scroll>
                                    </div>
                                    <div className="care" style={{ flex: 1, backgroundColor: this.props.background }}>
                                        <Scroll tabNumber={1} fatherSe=".care" render={com => (<SquareItemContainer key='2' backgroundColor={this.props.background} squareData={com} tabNumber={1}></SquareItemContainer>)}></Scroll>
                                    </div>
                                    <div className="update" style={{ flex: 1, backgroundColor: this.props.background }}>
                                        <Scroll tabNumber={2} fatherSe=".update" render={com => (<SquareItemContainer key='3' backgroundColor={this.props.background} squareData={com} tabNumber={2}></SquareItemContainer>)}></Scroll>
                                    </div>
                                </Tabs>
